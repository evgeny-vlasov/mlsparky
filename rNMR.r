...
.onLoad <- function(lib, pkg){
	...
	rNMRfun <- c('appendPeak', 'bringFocus', 'buttonDlg', 'ca', 'cf', 'closeGui', 
			'co', 'ct', 'ctd', 'ctu', 'cw', 'da', 'dd', 'di', 'dp', 'dr', 'draw2D', 
			'drawNMR', 'drf', 'ed', 'ep', 'err', 'export', 'fc', 'ff', 'fo', 'fs', 
			'getTitles', 'gui', 'hideGui', 'import', 'isNoise', 'loc', 'localMax', 
			'matchShift', 'maxShift', 'mmcd', 'myAssign', 'myDialog', 'myDir', 
			'myFile', 'myMsg', 'myOpen', 'mySave', 'mySelect', 'myToplevel', 'nf', 
			'ol', 'pa', 'paAll', 'pd', 'pDel', 'pDelAll', 'pe', 'peakPick', 
